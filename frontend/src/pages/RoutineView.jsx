...
function generateSeriesPrintHtml(seriesLabel, semesterLabel, slots) {
  ...
  function slotTd(slot, colspan) {
    ...
    return `<td colspan="${colspan}" style="border:${BORDER};padding:2px 3px;text-align:center;vertical-align:middle;height:${ROW_H}px;overflow:hidden;">
      ...
      <div style="font-size:8px;line-height:1.3;color:#000;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${teacher}</div>
    </td>`;
  }
...
<div style="text-align:center;margin-bottom:6px;line-height:1.5;">
  ...
  <div style="font-size:10px;font-weight:700;color:#000;">${semDisplay} Semester Class Routine — ${seriesLabel} Series</div>
