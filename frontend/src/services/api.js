...
export const addSeries = (series, currentSemester, label) =>
  api.post('/api/series', { series, currentSemester, label }).then(r => r.data);

export const updateSeriesSemester = (series, currentSemester) =>
  api.patch(`/api/series/${series}/semester`, { currentSemester }).then(r => r.data);
...
export const fetchRoutine = (series, batch = 'all') =>
  api.get(`/api/routine/${series}`, { params: { batch } }).then(r => r.data);
